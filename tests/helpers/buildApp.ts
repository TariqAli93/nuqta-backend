...
async function loadTestModules() {
  const [
    ...
    import("../../src/routes/v1/purchase-invoices/index.ts"),
    import("../../src/routes/v1/reports/index.ts"),
    import("../../src/routes/v1/sales/index.ts"),
    import("../../src/routes/v1/sales-invoices/index.ts"),
  ...
  return {
    ...
    routes: [
      ...
      { prefix: "/purchase-invoices", plugin: purchaseInvoices.default },
      { prefix: "/reports", plugin: reports.default },
      { prefix: "/sales", plugin: sales.default },
      { prefix: "/sales-invoices", plugin: salesInvoices.default },
