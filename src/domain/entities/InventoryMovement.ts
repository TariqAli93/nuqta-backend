...
export const InventoryMovementSchema = z.object({
  ...
  reason: z.enum(["sale", "purchase", "return", "cancellation", "refund", "damage", "manual", "opening"]),
  ...
  sourceType: z.enum(["sale", "purchase", "adjustment", "return", "sale_cancellation", "sale_refund"]).optional(),
