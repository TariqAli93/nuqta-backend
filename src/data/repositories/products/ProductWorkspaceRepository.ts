...
import type { PurchaseHistoryItem, SalesHistoryItem } from "../../../domain/index.js";
...
export class ProductWorkspaceRepository {
  ...
  async getPurchaseHistory(
    ...
    return rows as unknown as PurchaseHistoryItem[];
  }
  ...
  async getSalesHistory(
    ...
    return rows as unknown as SalesHistoryItem[];
  }
