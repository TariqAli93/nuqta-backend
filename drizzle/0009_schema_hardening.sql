...
ALTER TABLE "users"
  ...
  ALTER COLUMN "role" SET DEFAULT 'cashier'::"user_role";
...
ALTER TABLE "product_batches"
  ...
  ALTER COLUMN "status" SET DEFAULT 'active'::"product_batch_status",
...
ALTER TABLE "sales"
  ...
  ALTER COLUMN "status" SET DEFAULT 'pending'::"sale_status",
...
ALTER TABLE "payments"
  ...
  ALTER COLUMN "status" SET DEFAULT 'completed'::"payment_status";
...
ALTER TABLE "payroll_runs"
  ...
  ALTER COLUMN "status" SET DEFAULT 'draft'::"payroll_run_status";
...
ALTER TABLE "posting_batches"
  ...
  ALTER COLUMN "period_type" SET DEFAULT 'day'::"posting_batch_period_type",
  ...
  ALTER COLUMN "status" SET DEFAULT 'posted'::"posting_batch_status";
...
ALTER TABLE "reconciliations"
  ...
  ALTER COLUMN "status" SET DEFAULT 'open'::"reconciliation_status";
ALTER TABLE "barcode_templates"
  ...
  ALTER COLUMN "barcode_type" SET DEFAULT 'CODE128'::"barcode_type";
ALTER TABLE "barcode_print_jobs"
  ALTER COLUMN "expiry_date" TYPE date USING CASE WHEN "expiry_date" IS NULL THEN NULL ELSE "expiry_date"::date END,
  ALTER COLUMN "status" DROP DEFAULT,
  ALTER COLUMN "status" TYPE "barcode_print_job_status" USING "status"::"barcode_print_job_status",
  ALTER COLUMN "status" SET DEFAULT 'pending'::"barcode_print_job_status";
...
ALTER TABLE "accounting_settings"
  ...
  ALTER COLUMN "cost_method" SET DEFAULT 'fifo'::"accounting_cost_method",
  ...
  ALTER COLUMN "rounding_method" SET DEFAULT 'round'::"accounting_rounding_method";
ALTER TABLE "pos_settings"
  ALTER COLUMN "paper_size" DROP DEFAULT,
  ALTER COLUMN "paper_size" TYPE "pos_paper_size" USING "paper_size"::"pos_paper_size",
  ALTER COLUMN "paper_size" SET DEFAULT 'thermal'::"pos_paper_size",
  ...
  ALTER COLUMN "layout_direction" SET DEFAULT 'rtl'::"pos_layout_direction";
--> statement-breakpoint
